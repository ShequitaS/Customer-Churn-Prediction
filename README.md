...
`figures/retention_call_list_top200.csv` is the actual deliverable: the top 200
...
```
data/bank_churn.csv                     10,000-customer public dataset
src/churn_analysis.py                   full pipeline — EDA, models, economics
figures/churn_analysis.png              ROC, net-value curve, drivers, deciles
figures/retention_call_list_top200.csv  the deliverable: ranked call list
figures/threshold_economics.csv         net value at every threshold
figures/risk_deciles.csv                decile summary
```

Run with: `python src/churn_analysis.py`
