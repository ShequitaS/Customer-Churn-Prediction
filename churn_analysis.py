...
scored.sort_values("churn_prob", ascending=False).head(200) \
      .to_csv("figures/retention_call_list_top200.csv", index=False)
...
plt.tight_layout()
plt.savefig("figures/churn_analysis.png", bbox_inches="tight")
print("\nSaved: figures/churn_analysis.png")
print("Saved: figures/retention_call_list_top200.csv")

econ.to_csv("figures/threshold_economics.csv", index=False)
dec.to_csv("figures/risk_deciles.csv")
print("Saved: figures/threshold_economics.csv, figures/risk_deciles.csv")
